<template>
    <div class="container-fluid p-0">
        <div class="page-header header-filter header-small" data-parallax="true" style=" background-image: url('https://cdn.relovv.com/images/bg_web-min.jpeg'); ">
            <div class="container">
                <div class="row">
                ...
                <div class="about-team team-1">
                    <div class="row">
                        <div class="col-md-8 ml-auto mr-auto text-center">
                            ...
                            <h5 class="description">In order to build amazing entertainment, we need amazing talent.  </h5>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="card card-profile card-plain">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Test Test1</h4>
                        ...
                        <div class="col-md-4">
                            <div class="card card-profile card-plain">
                                <div class="card-avatar">
                                    <a href="#pablo">
                                        <img class="img" src="images/profile/john-janetos.jpeg">
                                    </a>
                                </div>
                                <div class="card-body">
                                    <h4 class="card-title">Test Test2</h4>
                                    <h6 class="category text-muted">Community Manager</h6>
                                    <p class="card-description">
                ...
                <div class="about-contact">
                    <div class="row">
                        <div class="col-md-8 ml-auto mr-auto">
                            ...
                            <h4 class="text-center description">Well, what are you waiting for.  We're hiring.  Click on the link below to see which positions your qualify for.</h4>
                            <div class="row">
                                <div class="col-md-4 ml-auto mr-auto text-center">
                                    <a href="/hiring" class="btn btn-primary btn-round">
                                        Apply
                                    </a>
                                </div>
                            </div>
